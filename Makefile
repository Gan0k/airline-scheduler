all: practica_v1_EK practica_v1_PR practica_v2_EK practica_v2_PR
...
practica_v2_PR: practica_v2_PR.cpp
	g++ practica_v2_PR.cpp -o practica_v2_PR -Wall -std=c++0x -O2

clean: 
	rm -f practica_v1_EK practica_v1_PR practica_v2_EK practica_v2_PR